...
Importing libraries and previous deliverables. 
...
Some unintended consequences that might arise from using this data approach to predict how long a director would stay at their position is that once a good model is made, HR representatives could adjust their compensation to make a director stay longer at their company. This could also go the other way as well. For example, if a director is not performing at their peak levels, they would adjust some of the variables to make a director leave their jobs. 
