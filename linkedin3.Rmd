...
ggplot(x, aes(name, followerCount)) + geom_col() + 
  ...
  labs(x="Company",y="Follower Count",title="Follower Count vs. Company")
```
...
#Let's plot it
ggplot(data = test, aes(x = predictions, y = avgMemberPosDuration)) + geom_jitter() + 
  labs(x="prediction",y="Average Position Duration",title="Average Position Duration vs. Prediction") +
...
#Let's plot it
ggplot(data = test, aes(x = predictions, y = avgMemberPosDuration)) + 
  geom_jitter() + 
  geom_smooth(method="lm") + 
  labs(x="prediction",y="Average Position Duration",title="Average Position Duration vs. Prediction")
